...
[Authorize]
public class AnalyticsDayController : Controller
{
    ...
    public AnalyticsDayController(IIdentityService identityService,
    ...
    {
        var data = new List<GetTBAnalyticsDayDto>();
        ...
        try
        {
            ...
            var query = await _catDayService.GetTBAnalyticsDayAsync(new ParametersTBAnalyticsDto
            {
        ...
        catch (Exception ex)
        {
            ...
            _logService.ErrorLog($"Controller: AnalyticsDay, Action: JsonDataTable", ex);
        }
