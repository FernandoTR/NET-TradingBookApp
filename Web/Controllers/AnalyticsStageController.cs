...
[Authorize]
public class AnalyticsStageController : Controller
{
    ...
    public AnalyticsStageController(IIdentityService identityService,
    ...
    {
        var data = new List<GetTBAnalyticsStageDto>();
        ...
        try
        {
            ...
            var query = await _catStageService.GetTBAnalyticsStageAsync(new ParametersTBAnalyticsDto
            {
        ...
        catch (Exception ex)
        {
            ...
            _logService.ErrorLog($"Controller: AnalyticsStage, Action: JsonDataTable", ex);
        }
