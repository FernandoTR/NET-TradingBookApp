...
[Authorize]
public class AnalyticsDirectionController : Controller
{
    ...
    private static int permissionNumber = (int)Permissions.AnalyticsDirection;

    public AnalyticsDirectionController(IIdentityService identityService,
    ...
    {
        var data = new List<GetTBAnalyticsDirectionDto>();
        ...
        try
        {
            ...
            var query = await _catDirectionService.GetTBAnalyticsDirectionAsync(new ParametersTBAnalyticsDto
            {
        ...
        catch (Exception ex)
        {
            ...
            _logService.ErrorLog($"Controller: AnalyticsDirection, Action: JsonDataTable", ex);
        }
