...
public class CatFigureController : Controller
{
    ...
    private readonly IGenericRepository<CatFigure> _catFigureRepository;
    ...
    public CatFigureController(IIdentityService identityService,
                               ...
                               IGenericRepository<CatFigure> catFigureRepository)
    {
    ...
    public async Task<ActionResult> JsonDataTable()
    {
        ...
        try
        {
            ...
            var query = (await _catFigureRepository
                        .GetAllAsync())
    ...
    public async Task<IActionResult> Save(CatFigureViewModel model)
    {
        ...
        try
        {
            ...
            if (await _catFigureRepository.AddAsync(figure))
            {
    ...
    public async Task<IActionResult> Edit(int id)
    {
        ...
        try
        {
            var figure = await _catFigureRepository.GetByIdAsync(id);
    ...
    public async Task<IActionResult> Update(CatFigureViewModel model)
    {
        ...
        try
        {
            ...
            if (await _catFigureRepository.UpdateAsync(figure))
            {
                notification = NotificationType.Success;
    ...
    public async Task<IActionResult> Delete([FromBody] int id)
    {
        ...
        try
        {
            bool isDeleted = await _catFigureRepository.DeleteAsync(id);
